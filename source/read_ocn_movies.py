...
def read_ocn_movies():
    ...
    now_ocn_html = requests.get("http://ocnmovies.tving.com/ocnmovies/schedule?startDate="+now_day)
    now_ocn_soup = BeautifulSoup(now_ocn_html.text, 'html5lib')

    tomo_ocn_html = requests.get("http://ocnmovies.tving.com/ocnmovies/schedule?startDate="+tomo_day)
...
if __name__ == '__main__':
    airTime_ocnM_list, program_ocnM_list = read_ocn_movies()
